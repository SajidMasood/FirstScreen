package com.nayyab.tech.splashscreen;
...
import com.nayyab.tech.splashscreen.utilties.Constants;
...
public class SplashScreen extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        // TODO: 4/17/2020 If the Android version is lower than Jellybean, use this call to hide the status bar.
        ...
        //Customize Title
        configSplash.setTitleSplash("Sajid Mehsud");
        configSplash.setTitleTextColor(R.color.white);
        configSplash.setTitleTextSize(30f); //float value
        configSplash.setAnimTitleDuration(3000);
        configSplash.setAnimTitleTechnique(Techniques.FlipInX);
        configSplash.setTitleFont("fonts/diti_sweet.ttf");
        //provide string to your font located in assets/fonts/ (More fonts are available in fonts folder)
